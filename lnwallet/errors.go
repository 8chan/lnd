...
func ErrChanReserveTooSmall(reserve, dustLimit monautil.Amount) ReservationError {
	return ReservationError{
...
func ErrChanReserveTooLarge(reserve,
	maxReserve monautil.Amount) ReservationError {
	return ReservationError{
...
func ErrChanTooSmall(chanSize, minChanSize monautil.Amount) ReservationError {
	return ReservationError{
