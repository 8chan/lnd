...
//
// This is a part of the WalletController interface.
func (b *BtcWallet) ConfirmedBalance(confs int32) (monautil.Amount, error) {
...
//
// This is a part of the WalletController interface.
func (b *BtcWallet) NewAddress(t lnwallet.AddressType, change bool) (monautil.Address, error) {
...
//
// This is a part of the WalletController interface.
func (b *BtcWallet) IsOurAddress(a monautil.Address) bool {
...
func (b *BtcWallet) SendOutputs(outputs []*wire.TxOut,
	...
	// SendOutputs.
	feeSatPerKB := monautil.Amount(feeRate.FeePerKVByte())
...
func (b *BtcWallet) ListUnspentWitness(minConfs, maxConfs int32) (
	...
	for _, output := range unspentOutputs {
		...
		if addressType == lnwallet.WitnessPubKey ||
			...
			// BTC to satoshis.
			amt, err := monautil.NewAmount(output.Amount)
			if err != nil {
				return nil, err
			}
...
func minedTransactionsToDetails(
	...
	for _, tx := range block.Transactions {
		...
		var destAddresses []monautil.Address
