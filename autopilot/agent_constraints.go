...
type AgentConstraints interface {
	...
	ChannelBudget(chans []Channel, balance monautil.Amount) (
		monautil.Amount, uint32)
...
func NewConstraints(minChanSize, maxChanSize monautil.Amount, chanLimit,
...
func (h *agentConstraints) ChannelBudget(channels []Channel,
	funds monautil.Amount) (monautil.Amount, uint32) {
	...
	var totalChanAllocation monautil.Amount
	...
	targetAllocation := monautil.Amount(float64(totalFunds) * h.allocation)
...
//
// Note: part of the AgentConstraints interface.
func (h *agentConstraints) MinChanSize() monautil.Amount {
...
//
// Note: part of the AgentConstraints interface.
func (h *agentConstraints) MaxChanSize() monautil.Amount {
