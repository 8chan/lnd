...
func createTestChannel(alicePrivKey, bobPrivKey []byte,
	aliceAmount, bobAmount, aliceReserve, bobReserve monautil.Amount,
...
func createClusterChannels(aliceToBob, bobToCarol monautil.Amount) (
...
func createTwoClusterChannels(aliceToBob, bobToCarol monautil.Amount) (
