...
// policy's fee rate.
func (p *Policy) ComputeAltruistOutput(totalAmt monautil.Amount,
	txWeight int64) (monautil.Amount, error) {
...
func (p *Policy) ComputeRewardOutputs(totalAmt monautil.Amount,
	txWeight int64) (monautil.Amount, monautil.Amount, error) {
...
func ComputeRewardAmount(total monautil.Amount, base, rate uint32) monautil.Amount {
	rewardBase := monautil.Amount(base)
	rewardRate := monautil.Amount(rate)
...
func (p *Policy) ComputeJusticeTxOuts(totalAmt monautil.Amount, txWeight int64,
