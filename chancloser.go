...
type channelCloser struct {
	...
	lastFeeProposal monautil.Amount
	...
	priorFeeOffers map[monautil.Amount]*lnwire.ClosingSigned
...
func newChannelCloser(cfg chanCloseCfg, deliveryScript []byte,
	...
	return &channelCloser{
		...
		priorFeeOffers:      make(map[monautil.Amount]*lnwire.ClosingSigned),
	}
}
...
func (c *channelCloser) proposeCloseSigned(fee monautil.Amount) (*lnwire.ClosingSigned, error) {
...
func feeInAcceptableRange(localFee, remoteFee monautil.Amount) bool {
...
// offered fee.
func rachetFee(fee monautil.Amount, up bool) monautil.Amount {
...
func calcCompromiseFee(chanPoint wire.OutPoint,
	ourIdealFee, lastSentFee, remoteFee monautil.Amount) monautil.Amount {
