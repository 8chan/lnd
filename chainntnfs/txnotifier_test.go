...
func TestTxNotifierFutureConfDispatch(t *testing.T) {
	...
	block1 := monautil.NewBlock(&wire.MsgBlock{
	...
	block2 := monautil.NewBlock(&wire.MsgBlock{})
...
func TestTxNotifierConfReorg(t *testing.T) {
	...
	block3 := monautil.NewBlock(&wire.MsgBlock{
		Transactions: []*wire.MsgTx{&tx2, &tx3},
	})
	block4 := monautil.NewBlock(&wire.MsgBlock{})
...
func TestTxNotifierSpendReorg(t *testing.T) {
	...
	emptyBlock := monautil.NewBlock(&wire.MsgBlock{})
	err = n.ConnectTip(
...
func TestTxNotifierNtfnDone(t *testing.T) {
	...
	for i := nextHeight; i < nextHeight+reorgSafetyLimit; i++ {
		dummyBlock := monautil.NewBlock(&wire.MsgBlock{})
